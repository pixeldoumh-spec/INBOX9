...
routing_gate_ok BOOLEAN NOT NULL DEFAULT FALSE,
...
CREATE INDEX IF NOT EXISTS idx_provider_production_readiness_status ON provider_production_readiness(status, checked_at DESC);
ALTER TABLE provider_production_readiness ENABLE ROW LEVEL SECURITY;
INSERT INTO schema_migrations(version) VALUES ('044_provider_production_readiness') ON CONFLICT (version) DO NOTHING;
COMMIT;