...
- [x] Phase 8.2 non-billable India catalog verification path\n- [x] Phase 8.3 exact active-catalog provider mapping workflow
- [x] Phase 8.4 controlled provider lifecycle certification
