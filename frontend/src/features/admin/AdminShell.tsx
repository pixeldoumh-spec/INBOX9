...
function AdminShell(){
  ...
  const items=[['/admin','Dashboard'],['/admin/users','Users'],['/admin/services','Services & routing'],['/admin/activations','Activation operations'],['/admin/payments','Payment operations'],['/admin/support','Support'],['/admin/notifications','Notifications'],['/admin/reconciliation','Reconciliation & audit']] as const;
