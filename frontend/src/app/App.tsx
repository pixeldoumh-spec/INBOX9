...
function BuyServiceWorkspace({serviceId}:{serviceId:string}){
 ...
 return <section className="page-section service-detail buy-workspace">
  ...
  {!selected.purchasable?<div className="info-card"><Icon name="clock" size={20}/><div><strong>Buying is not enabled for this service yet.</strong><p>This service is temporarily unavailable for new activations.</p></div></div>:null}
  ...
  <div className="trust-row"><span><Icon name="check" size={16}/> Secure session</span><span><Icon name="check" size={16}/> India · +91</span><span><Icon name="clock" size={16}/> Automatic OTP updates</span></div>
 </section>
}
