...
import recharges from './api/recharges/index.js';
import activations from './api/activations/index.js';
import activationById from './api/activations/[id].js';
import activationCancel from './api/activations/[id]/cancel.js';
import serviceServers from './api/services/[id]/servers.js';
import adminOverview from './api/admin/overview.js';
import adminRecharges from './api/admin/recharges/index.js';
import adminRechargeById from './api/admin/recharges/[id].js';
import adminUsers from './api/admin/users.js';
import adminServices from './api/admin/services.js';
import adminServiceById from './api/admin/services/[id].js';
import adminActivations from './api/admin/activations.js';
import adminLedger from './api/admin/ledger.js';
import adminProviders from './api/admin/providers.js';
import adminProvidersHealth from './api/admin/providers-health.js';
